...
export interface SpindleDOMHelper {
    ...
    createElement<K extends keyof HTMLElementTagNameMap>(tag: K, attrs?: Record<string, string>): HTMLElementTagNameMap[K];
...
export type SpindleMountPoint = "sidebar" | "chat_header_left" | "chat_header_center" | "chat_header_right" | "chat_top_dock" | "chat_bottom_dock" | "chat_surface_side" | "chat_sidebar_left" | "chat_sidebar_right" | "chat_stream_before" | "chat_stream_after" | "chat_empty_state" | "chat_composer_above" | "chat_composer_below" | "chat_input_tools_left" | "chat_input_tools_right" | "chat_actions" | "chat_toolbar" | "message_header" | "message_body_before" | "message_body_after" | "message_footer" | "message_actions" | "message_edit_actions" | "message_context_menu" | "message_swipe_indicators" | "landing_header" | "landing_hero" | "landing_characters" | "landing_recent_chats" | "landing_footer" | "sidebar_top" | "sidebar_bottom" | "drawer_tab" | "drawer_header_actions" | "drawer_footer" | "character_editor_tab" | "character_browser_card_actions" | "preset_editor_tab" | "preset_editor_toolbar" | "persona_editor_tab" | "world_book_entry_table" | "world_book_entry_row" | "world_book_entry_editor" | "world_book_entry_toolbar" | "lorebook_workspace" | "lorebook_half_workspace" | "loom_builder_toolbar" | "loom_builder_inspector" | "regex_entry_row" | "settings_tab" | "settings_section" | "settings_card_actions" | "settings_extensions" | "modal_header_actions" | "modal_footer_actions" | "command_palette_actions" | "manage_chats_actions" | "prompt_variables_toolbar";
/**
...
export interface SpindleCharacterEditorHelper {
    ...
    updateExtensions(mutator: (extensions: Record<string, any>) => Record<string, any>, options?: SpindleCharacterEditorSaveOptions): void;
...
export interface SpindlePresetEditorHelper {
    ...
    updatePreset(mutator: (preset: SpindlePresetEditorDraft) => SpindlePresetEditorDraft, options?: SpindlePresetEditorSaveOptions): void;
...
export interface SpindlePresetEditorScopedHelper {
    ...
    updateMetadata(mutator: (current: unknown) => Record<string, unknown>, options?: SpindlePresetEditorSaveOptions): void;
...
export interface SpindleUIEventsHelper {
     ...
     */
    bindActionHandlers(target: string | Element, handlers: Record<string, (detail: SpindleUIDomActionDetail) => void>, options?: SpindleUIDomActionBindingOptions): () => void;
}
...
export interface SpindleFrontendProcessRegistry {
     ...
     */
    register(kind: string, handler: (process: SpindleFrontendProcessContext) => void | (() => void) | Promise<void | (() => void)>): () => void;
}
...
export interface SpindleFrontendMessagesAPI {
    ...
    update(chatId: string, messageId: string, input: {
        content?: string;
    }): Promise<unknown>;
...
export interface SpindleFrontendContext {
    ...
    messages: {
        registerTagInterceptor(options: SpindleMessageTagInterceptorOptions, handler: (payload: SpindleMessageTagIntercept) => void): () => void;
        /** Render or replace a sandboxed widget below a message. Returns a cleanup function. */
        renderWidget(options: SpindleMessageWidgetOptions, handler?: (payload: unknown) => void): () => void;
    ...
    chats: {
        ...
        updateMessage(chatId: string, messageId: string, input: {
            content?: string;
        }): Promise<unknown>;
...
export interface SpindleFrontendModule {
    setup(ctx: SpindleFrontendContext): void | SpindleFrontendTeardown | Promise<void | SpindleFrontendTeardown>;
    teardown?(): void | Promise<void>;
}
/** A lightweight native floating-widget frontend module. */
export interface SpindleWidgetFrontendModule {
    setupWidget(ctx: SpindleFrontendContext, target: SpindleFrontendWidgetTarget): void | SpindleFrontendTeardown | Promise<void | SpindleFrontendTeardown>;
    teardown?(): void | Promise<void>;
}
