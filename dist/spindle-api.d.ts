...
export interface SpindleAPI {
     ...
     */
    registerInterceptor(handler: InterceptorHandler, priority?: number, options?: InterceptorRegistrationMatchOptions): InterceptorDisposer;
    ...
    ephemeral: {
        ...
        readBinary(path: string): Promise<Uint8Array>;
        writeBinary(path: string, data: Uint8Array, options?: {
            ttlMs?: number;
            reservationId?: string;
        }): Promise<void>;
        delete(path: string): Promise<void>;
        ...
        requestBlock(sizeBytes: number, options?: {
            ttlMs?: number;
            reason?: string;
        }): Promise<{
            reservationId: string;
    ...
    chat: {
        ...
        appendMessage(chatId: string, message: {
            role: "system" | "user" | "assistant";
            content: string;
            metadata?: Record<string, unknown>;
        }, options?: ChatAppendMessageOptionsDTO): Promise<{
            id: string;
            generationId?: string;
        }>;
        /**
         ...
         */
        updateMessage(chatId: string, messageId: string, patch: {
            content?: string;
            metadata?: Record<string, unknown>;
            swipes?: string[];
            swipe_id?: number;
    ...
    events: {
        track(eventName: string, payload?: Record<string, unknown>, options?: {
    ...
    mcp: {
        ...
        tools: {
            ...
            call(serverId: string, toolName: string, args?: Record<string, unknown>, options?: McpToolCallOptionsDTO): Promise<string>;
        };
    };
    ...
    tokens: {
         ...
         */
        countMessages(messages: Array<Pick<LlmMessageDTO, "role" | "content">>, options?: TokenCountOptionsDTO): Promise<TokenCountResultDTO>;
    ...
    imageGen: {
         ...
         */
        getModels(connectionId: string, userId?: string): Promise<Array<{
            id: string;
            label: string;
        }>>;
    };
     ...
     */
    images: {
        list(options?: ImageListOptionsDTO): Promise<{
            data: ImageDTO[];
            total: number;
        }>;
        ...
        uploadMany(items: ImageUploadDTO[], options?: {
            userId?: string;
            concurrency?: number;
        }): Promise<Array<{
            id?: string;
         ...
         */
        deleteMany(imageIds: string[], options?: {
            userId?: string;
        }): Promise<number>;
    };
    /**
    ...
    presets: {
        ...
        blocks: {
            ...
            create(presetId: string, input: PromptBlockCreateDTO, options?: {
                index?: number;
                userId?: string;
            }): Promise<PromptBlockSnapshotDTO>;
    ...
    world_books: {
        ...
        entries: {
            list(worldBookId: string, options?: {
                limit?: number;
                offset?: number;
                userId?: string;
            }): Promise<{
                data: WorldBookEntryDTO[];
                total: number;
            }>;
     ...
     */
    regex_scripts: {
        list(options?: RegexScriptListOptionsDTO): Promise<{
            data: RegexScriptDTO[];
            total: number;
        }>;
    ...
    databanks: {
        ...
        documents: {
            ...
            getContent(documentId: string, userId?: string): Promise<{
                content: string;
            } | null>;
            reprocess(documentId: string, userId?: string): Promise<{
                success: true;
                status: "processing";
            }>;
        };
    ...
    memories: {
        ...
        entities: {
             ...
             */
            upsert(chatId: string, entity: MemoryEntityUpsertDTO, options?: {
                chunkId?: string | null;
                createdAt?: number;
                userId?: string;
            }): Promise<MemoryEntityDTO>;
        ...
        relations: {
             ...
             */
            upsert(chatId: string, relation: MemoryRelationUpsertDTO, options?: {
                chunkId?: string | null;
                userId?: string;
    ...
    council: {
        ...
        getMembers(options?: {
            userId?: string;
        }): Promise<CouncilMemberContext[]>;
        /** Retrieve all Lumia items generally available to the user (e.g. from packs) */
        getAvailableLumiaItems(options?: {
            userId?: string;
        }): Promise<LumiaItemDTO[]>;
    };
    /**
    ...
    rpcPool: {
         ...
         * Returns the fully-qualified endpoint name.
         */
        handle(endpoint: string, handler: (ctx: SharedRpcRequestContextDTO) => unknown | Promise<unknown>, policy?: SharedRpcEndpointPolicyDTO): string;
     ...
     * ```
     */
    registerWorldInfoInterceptor(handler: (ctx: WorldInfoInterceptorCtxDTO) => Promise<WorldInfoInterceptorResultDTO | void>, priority?: number): void;
    /**
     ...
     * ```
     */
    registerMessageContentProcessor(handler: (ctx: MessageContentProcessorCtxDTO) => Promise<MessageContentProcessorResultDTO | void>, priority?: number): void;
    /**
    ...
    macros: {
         ...
         * ```
         */
        resolve(template: string, options?: MacroResolveOptionsDTO): Promise<MacroResolveResultDTO>;
    };
    ...
    ui: {
         ...
         */
        getDrawerTabs(options?: {
            userId?: string;
        }): Promise<SpindleUIDrawerTabDTO[]>;
        /**
        ...
        getSettingsTabs(options?: {
            userId?: string;
        }): Promise<SpindleUISettingsTabDTO[]>;
        /**
         ...
         */
        openDrawerTab(tabId: string, options?: {
            userId?: string;
        }): Promise<void>;
         ...
         */
        openSettings(viewId?: string, options?: {
            userId?: string;
        }): Promise<void>;
    ...
    toast: {
        success(message: string, options?: {
            title?: string;
            duration?: number; /** For operator-scoped extensions only. */
            userId?: string;
        }): void;
    ...
    commands: {
         ...
         * Returns an unsubscribe function.
         */
        onInvoked(handler: (commandId: string, context: SpindleCommandContextDTO) => void | Promise<void>): () => void;
    };
    /**
